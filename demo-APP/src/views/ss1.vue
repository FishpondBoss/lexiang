<template>
  <div>
    ...
    <van-uploader :before-read="beforeRead" :after-read="afterRead" v-model="fileList" multiple :max-count="9">
  ...
  export default {
    ...
    methods: {
      ...
      fb(){
        ...
        var url = "img/upload";
        var obj={time:this.time,msg:this.msg,fileList:this.fileList};
        console.log(obj)
        this.axios.get(url,{params:obj})
          .then(res=>{
        
          this.$messagebox("消息","分享成功")
